...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/GCPins/pterodactyl-installer-lm"}
...
welcome() {
  ...
  output "https://github.com/GCPins/pterodactyl-installer-lm"
  output ""
